...
#collage query
            ...
            elif "principal" in query or "vice principal" in query:
                speak("Dr.G.SELVAKUMAR-PRINCIPAL")
                print("Dr.G.SELVAKUMAR-PRINCIPAL")
                speak("Dr.L.PRABHU-VICE PRINCIPAL")
                print("Dr.L.PRABHU-VICE PRINCIPAL")
                speak("Dr.S.P.SANGEETHA-VICE PRINCIPAL")
                print("Dr.S.P.SANGEETHA-VICE PRINCIPAL")
                
            elif "program" in query or "course" in query:
                speak("B.E. - Computer Science and Engineering")
                print("B.E. - Computer Science and Engineering")
                speak("B.E. - Computer Science and Engineering (Artificial Intelligence and Machine Learning)")
                print("B.E. - Computer Science and Engineering (Artificial Intelligence and Machine Learning)")
                speak("B.E. - Computer Science and Engineering (Cyber Security)")
                print("B.E. - Computer Science and Engineering (Cyber Security)")
                speak("B.E. - Computer Science and Design")
                print("B.E. - Computer Science and Design")

            elif "contact" in query:
                speak("AV CAMPUS-Vinayaka Nagar,Old Mahabalipuram road,Paiyanoor,Chengalpattu District,Chennai-603 104,Tamil Nadu,INDIA.")
                print("AV CAMPUS-Vinayaka Nagar,Old Mahabalipuram road,Paiyanoor,Chengalpattu District,Chennai-603 104,Tamil Nadu,INDIA.")
                speak("MAIL-info@avit.ac.in")
                print("MAIL-info@avit.ac.in")
                speak("CONTACT-TOLL FREE:1800 309 4350")
                print("CONTACT-TOLL FREE:1800 309 4350")
